...
export const metadata: Metadata = {
  title: "Commercial Cleaning San Juan Capistrano | Janitorial Services",
  description: "Professional commercial cleaning services in San Juan Capistrano, CA. Office cleaning, floor care, disinfection. Women-owned, licensed & insured. Free quotes - (949) 687-8297",
  keywords: ['commercial cleaning San Juan Capistrano', 'janitorial services SJC', 'office cleaning San Juan Capistrano CA'],
  openGraph: {
    title: "Commercial Cleaning San Juan Capistrano | Rosie's Janitorial",
    description: 'Professional commercial cleaning in San Juan Capistrano. Women-owned, licensed & insured.',
    url: 'https://rosiesjanitorialoc.com/service-areas/san-juan-capistrano',
  },
  alternates: { canonical: 'https://www.rosiesjanitorialoc.com/service-areas/san-juan-capistrano' },
};
      ...
      <main>
        <section className="bg-neutral-950 text-white pt-32 pb-20">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              <p className="text-neutral-500 text-sm uppercase tracking-widest mb-4">San Juan Capistrano, CA</p>
              <h1 className="text-5xl md:text-6xl leading-tight mb-6">Commercial Cleaning in San Juan Capistrano</h1>
              <p className="text-xl text-neutral-400 max-w-2xl mb-10">
                Professional janitorial services for San Juan Capistrano businesses. Women-owned, licensed & insured. Serving the 92675 and 92693 areas.
              </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-3 gap-16">
              <div>
                ...
                <h2 className="text-4xl text-neutral-900 leading-tight">Complete commercial cleaning for San Juan Capistrano</h2>
              </div>
              <div className="lg:col-span-2">
                <div className="grid sm:grid-cols-2 gap-x-12 gap-y-10">
                  {[
                    ...
                    { title: "Retail Cleaning", desc: "Specialized cleaning for retail and hospitality." },
        ...
        <section className="py-24 bg-neutral-100">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <h2 className="text-4xl text-neutral-900 leading-tight mb-10">Serving all San Juan Capistrano areas</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-neutral-700">
                {["Historic Downtown", "Mission San Juan Capistrano area", "Los Rios District", "92675 area", "92693 area"].map((area, i) => (
        ...
        <section className="py-20 bg-neutral-950 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-neutral-400 mb-8 max-w-xl mx-auto">Free quotes and professional service for San Juan Capistrano businesses.</p>
