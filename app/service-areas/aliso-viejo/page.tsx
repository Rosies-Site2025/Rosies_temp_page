...
export const metadata: Metadata = {
  title: "Commercial Cleaning Aliso Viejo | Janitorial Services",
  description: "Professional commercial cleaning services in Aliso Viejo, CA. Office cleaning, floor care, disinfection. Women-owned, licensed & insured. Free quotes - (949) 687-8297",
  keywords: ['commercial cleaning Aliso Viejo', 'janitorial services Aliso Viejo', 'office cleaning Aliso Viejo CA'],
  openGraph: {
    title: "Commercial Cleaning Aliso Viejo | Rosie's Janitorial",
    description: 'Professional commercial cleaning in Aliso Viejo. Women-owned, licensed & insured.',
    url: 'https://rosiesjanitorialoc.com/service-areas/aliso-viejo',
  },
  alternates: { canonical: 'https://www.rosiesjanitorialoc.com/service-areas/aliso-viejo' },
};
      ...
      <main>
        <section className="bg-neutral-950 text-white pt-32 pb-20">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl">
              <p className="text-neutral-500 text-sm uppercase tracking-widest mb-4">Aliso Viejo, CA</p>
              <h1 className="text-5xl md:text-6xl leading-tight mb-6">Commercial Cleaning in Aliso Viejo</h1>
              <p className="text-xl text-neutral-400 max-w-2xl mb-10">
                Professional janitorial services for Aliso Viejo businesses. Women-owned, licensed & insured. Serving the 92656 area.
              </p>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-3 gap-16">
              <div>
                ...
                <h2 className="text-4xl text-neutral-900 leading-tight">Complete commercial cleaning for Aliso Viejo</h2>
              </div>
        ...
        <section className="py-24 bg-neutral-100">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <h2 className="text-4xl text-neutral-900 leading-tight mb-10">Serving all Aliso Viejo areas</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-neutral-700">
                {["Aliso Viejo Town Center", "Pacific Park", "Glenwood", "Wood Canyon", "All 92656 areas"].map((area, i) => (
        ...
        <section className="py-20 bg-neutral-950 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-neutral-400 mb-8 max-w-xl mx-auto">Free quotes and professional service for Aliso Viejo businesses.</p>
